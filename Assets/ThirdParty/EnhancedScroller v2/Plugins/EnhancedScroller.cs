...
namespace EnhancedUI.EnhancedScroller
{
    ...
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that called the delegate</param>
    /// <param name="val">The scroll value of the scroll rect</param>
    /// <param name="scrollPosition">The scroll position in pixels from the start of the scrollerDeployDel</param>
    public delegate void ScrollerScrolledDelegate(EnhancedScroller scroller, Vector2 val, float scrollPosition);

    /// <summary>
    /// This delegate handles the snapping of the scrollerDeployDel.
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that called the delegate</param>
    ...
    /// <summary>
    /// This delegate handles the change in state of the scrollerDeployDel (scrolling or not scrolling)
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that changed state</param>
    /// <param name="scrolling">Whether or not the scrollerDeployDel is scrolling</param>
    public delegate void ScrollerScrollingChangedDelegate(EnhancedScroller scroller, bool scrolling);

    /// <summary>
    /// This delegate handles the change in state of the scrollerDeployDel (jumping or not jumping)
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that changed state</param>
    /// <param name="tweening">Whether or not the scrollerDeployDel is tweening</param>
    ...
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that created the cell view</param>
    ...
    /// </summary>
    /// <param name="scroller">The scrollerDeployDel that reused the cell view</param>
    ...
    /// <summary>
    /// The EnhancedScroller allows you to easily set up a dynamic scrollerDeployDel that will recycle views for you. This means
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        /// <summary>
        /// The direction this scrollerDeployDel is handling
        /// </summary>
        ...
        /// the scrollerDeployDel is looping or there aren't enough items to scroll.
        /// </summary>
        ...
        /// <summary>
        /// The direction the scrollerDeployDel is handling
        /// </summary>
        ...
        /// <summary>
        /// The padding inside of the scrollerDeployDel: top, bottom, left, right.
        /// </summary>
        public RectOffset padding;

        /// <summary>
        /// Whether the scrollerDeployDel should loop the cell views
        /// </summary>
        [SerializeField]
        private bool loop;

		/// <summary>
        /// Whether the scrollerDeployDel should process loop jumping while being dragged.
		...
		/// <summary>
        /// The maximum speed the scrollerDeployDel can go. This can be useful to eliminate
        ...
        /// scrollerDeployDel slows down to this speed it will snap to the location
        /// specified.
        /// </summary>
        ...
        /// location in the scrollerDeployDel will be how which cell to snap to
        /// is determined.
        /// Typically, the offset is in the range 0..1, with 0 being
        /// the top / left of the scrollerDeployDel and 1 being the bottom / right.
        ...
        /// this location in the scrollerDeployDel will be where the snapped cell
        /// is moved to.
        /// Typically, the offset is in the range 0..1, with 0 being
        /// the top / left of the scrollerDeployDel and 1 being the bottom / right.
        /// In most situations the watch offset and the jump offset
        ...
        /// <summary>
        /// Once the cell has been snapped to the scrollerDeployDel location, this
        /// value will determine how the cell is centered on that scrollerDeployDel
        /// location.
        /// Typically, the offset is in the range 0..1, with 0 being
        ...
        /// <summary>
        /// While true keeps snapping while the scrollerDeployDel is dragged.
        /// While false, this will disable snapping until the dragging stops.
        /// </summary>
		public bool snapWhileDragging;

        /// <summary>
        /// The amount of space to look ahead before the scrollerDeployDel position.
        ...
        /// <summary>
        /// This delegate is called when the scrollerDeployDel has snapped to a position
        /// </summary>
        public ScrollerSnappedDelegate scrollerSnapped;

        /// <summary>
        /// This delegate is called when the scrollerDeployDel has started or stopped scrolling
        /// </summary>
        public ScrollerScrollingChangedDelegate scrollerScrollingChanged;

        /// <summary>
        /// This delegate is called when the scrollerDeployDel has started or stopped tweening
        /// </summary>
        public ScrollerTweeningChangedDelegate scrollerTweeningChanged;

        /// <summary>
        /// This delegate is called when the scrollerDeployDel creates a new cell view from scratch
        /// </summary>
        public CellViewInstantiated cellViewInstantiated;

        /// <summary>
        /// This delegate is called when the scrollerDeployDel reuses a recycled cell view
        /// </summary>
        public CellViewReused cellViewReused;

        /// <summary>
        /// The Delegate is what the scrollerDeployDel will call when it needs to know information about
        ...
        /// <summary>
        /// The absolute position in pixels from the start of the scrollerDeployDel
        /// </summary>
        ...
        /// <summary>
        /// The normalized position of the scrollerDeployDel between 0 and 1
        /// </summary>
        ...
        /// <summary>
        /// Whether the scrollerDeployDel should loop the resulting cell views.
        /// Looping creates three sets of internal size data, attempting
        /// to keep the scrollerDeployDel in the middle set. If the scrollerDeployDel goes
            ...
            set
            {
                ...
                if (_scrollbar != null)
                {
                    ...
                    if (_cellViewOffsetArray != null && _cellViewOffsetArray.Count > 0)
                    {
                        ...
                        {
                            // if the size of the scrollable area is smaller than the scrollerDeployDel
                        ...
                        {
                            // if the size of the scrollable areas is larger than the scrollerDeployDel
        ...
        /// <summary>
        /// This is the velocity of the scrollerDeployDel.
        /// </summary>
        ...
        /// The scrollerDeployDel should only be moving one one axix.
        /// </summary>
        ...
        /// <summary>
        /// Whether the scrollerDeployDel is scrolling or not
        /// </summary>
        ...
        /// <summary>
        /// Whether the scrollerDeployDel is tweening or not
        /// </summary>
        ...
        /// <summary>
        /// This is the first cell view index showing in the scrollerDeployDel's visible area
        /// </summary>
        ...
        /// <summary>
        /// This is the last cell view index showing in the scrollerDeployDel's visible area
        /// </summary>
        ...
        /// <summary>
        /// This is the first data index showing in the scrollerDeployDel's visible area
        /// </summary>
        ...
        /// <summary>
        /// This is the last data index showing in the scrollerDeployDel's visible area
        /// </summary>
        ...
        /// <summary>
        /// This is the number of cells in the scrollerDeployDel
        /// </summary>
        ...
        /// <summary>
        /// This is a convenience link to the scrollerDeployDel's scroll rect
        /// </summary>
        ...
        /// <summary>
        /// The size of the visible portion of the scrollerDeployDel
        /// </summary>
        ...
        /// </summary>
        /// <param name="scrollPositionFactor">The percentage of the scrollerDeployDel to start at between 0 and 1, 0 being the start of the scrollerDeployDel</param>
        ...
        /// <summary>
        /// Removes all cells, both active and recycled from the scrollerDeployDel.
        ...
        /// <summary>
        /// Jump to a position in the scrollerDeployDel based on a dataIndex. This overload allows you
        /// to specify a specific offset within a cell as well.
        /// </summary>
        /// <param name="dataIndex">he data index to jump to</param>
        /// <param name="scrollerOffset">The offset from the start (top / left) of the scrollerDeployDel in the range 0..1.
        /// Outside this range will jump to the location before or after the scrollerDeployDel's viewable area</param>
        /// <param name="cellOffset">The offset from the start (top / left) of the cell in the range 0..1</param>
        /// <param name="useSpacing">Whether to calculate in the spacing of the scrollerDeployDel in the jump</param>
        ...
        /// <summary>
        /// Snaps the scrollerDeployDel on command. This is called internally when snapping is set to true and the velocity
        ...
        /// <summary>
        /// Gets the scroll position in pixels from the start of the scrollerDeployDel based on the cellViewIndex
        /// </summary>
        ...
        /// <summary>
        /// Gets the scroll position in pixels from the start of the scrollerDeployDel based on the dataIndex
        /// </summary>
        ...
        /// </summary>
        /// <param name="position">The pixel offset from the start of the scrollerDeployDel</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Set after the scrollerDeployDel is first created. This allwos
        ...
        /// <summary>
        /// Reference to the delegate that will tell this scrollerDeployDel information
        /// about the underlying data
        /// </summary>
        private IEnhancedScrollerDelegate _delegate;

        /// <summary>
        /// Flag to tell the scrollerDeployDel to reload the data
        /// </summary>
        private bool _reloadData;

        /// <summary>
        /// Flag to tell the scrollerDeployDel to refresh the active list of cell views
        /// </summary>
        ...
        /// <summary>
        /// The position that triggers the scrollerDeployDel to jump to the end of the middle section
        /// of cell views. This keeps the scrollerDeployDel in the middle section as much as possible.
        /// </summary>
        private float _loopFirstJumpTrigger;

        /// <summary>
        /// The position that triggers the scrollerDeployDel to jump to the start of the middle section
        /// of cell views. This keeps the scrollerDeployDel in the middle section as much as possible.
        /// </summary>
		...
		/// <summary>
		/// The number of cells in one third of the allocated scrollerDeployDel space
        /// </summary>
        ...
        /// </summary>
        /// <param name="keepPosition">If true, then the scrollerDeployDel will try to go back to the position it was at before the resize</param>
        ...
        /// <summary>
        /// Updates the spacing on the scrollerDeployDel
        /// </summary>
        ...
        /// <summary>
        /// This function is called if the scrollerDeployDel is scrolled, updating the active list of cells
        /// </summary>
        ...
        private void _CalculateCurrentActiveCellRange(out int startIndex, out int endIndex)
        {
            ...
            // get the positions of the scrollerDeployDel
        ...
        /// <summary>
        /// Caches and initializes the scrollerDeployDel
        /// </summary>
        void Awake()
        {
            GameObject go;
            ...
            // force the scrollerDeployDel to scroll in the direction we want
		...
		/// <summary>
        /// This event is fired when the user begins dragging on the scrollerDeployDel.
		...
		/// <summary>
        /// This event is fired when the user ends dragging on the scrollerDeployDel.
        ...
        void Update()
        {
            ...
            // determine if the scrollerDeployDel has started or stopped scrolling
        ...
        void OnEnable()
        {
            // when the scrollerDeployDel is enabled, add a listener to the onValueChanged handler
            _scrollRect.onValueChanged.AddListener(_ScrollRect_OnValueChanged);
        }

        void OnDisable()
        {
            // when the scrollerDeployDel is disabled, remove the listener
            _scrollRect.onValueChanged.RemoveListener(_ScrollRect_OnValueChanged);
        }

        /// <summary>
        /// Handler for when the scrollerDeployDel changes value
        /// </summary>
        ...
        private void _ScrollRect_OnValueChanged(Vector2 val)
        {
            ...
            if (snapping && !_snapJumping)
            {
                ...
                {
                    // Make sure the scrollerDeployDel is not on the boundary if not looping
        ...
        private void SnapJumpComplete()
        {
            ...
            // fire the scrollerDeployDel snapped delegate
