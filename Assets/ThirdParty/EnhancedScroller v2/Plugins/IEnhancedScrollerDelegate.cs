...
{
    /// <summary>
    /// All scripts that handle the scrollerDeployDel's callbacks should inherit from this interface
    /// </summary>
    public interface IEnhancedScrollerDelegate
    {
        ...
        /// of this function should request a new cell from the scrollerDeployDel so that it can
